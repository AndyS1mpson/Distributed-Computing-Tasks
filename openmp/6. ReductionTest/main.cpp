/*
Задача:
Реализовать операцию редукции с использованием разных способов организации
взаимоисключения (атомарные операции, критические секции, синхронизация при помощи замков).
*/
#include <omp.h>
#include <stdio.h>
#include <fstream>
